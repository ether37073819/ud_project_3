...
contract SupplyChain is ConsumerRole, DistributorRole, FarmerRole, RetailerRole{
  ...
  // modifer to send any excess ether back to buyer 
  modifier checkExcess(uint _upc) {
    _;
    uint _price = items[_upc].productPrice;
    uint amountToRefund = msg.value - _price;
    items[_upc].distributorID.transfer(amountToRefund);
    }
  ...
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude, string  _productNotes) public 
  {
    ...
    uint id = _upc + sku;
    items[_upc] = Item({sku: sku, upc: _upc, ownerID: _originFarmerID, originFarmerID: _originFarmerID, originFarmName: _originFarmName, originFarmInformation: _originFarmInformation, originFarmLatitude: _originFarmLatitude, originFarmLongitude: _originFarmLongitude, productID: id, productNotes: _productNotes, productPrice: 0, itemState: State.Harvested, distributorID: 0, retailerID: 0, consumerID: 0});
    // Increment sku
    sku = sku + 1;
  ...
  function buyItem(uint _upc) forSale(_upc) paidEnough(items[_upc].productPrice) checkExcess(_upc) public payable
    { 
